...
agg-anno \
	-m chr19_qced.mt \
	-a chr19_vep_anno.ht \
	-j /home/dnanexus/gwas_preprocessing/scripts/vep_agg_json/v0_common_lof_by_gene_id_oms.json \
	-s /home/dnanexus/unindexed_chr19_common_lof_by_gene_id_oms.parquet \
	-u rdevito_p1_db

python3 ../../annotation/rewrite_agg_table.py \
	-p /home/dnanexus/unindexed_chr19_common_lof_by_gene_id_oms.parquet \
